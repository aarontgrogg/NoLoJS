...
- Nothign special is required in your HTML; this is all one line of CSS: `position: sticky;`
...
- Note elements can be scoped within a container, so that as you scroll, one element can "replace" another as the "sticky" element.
